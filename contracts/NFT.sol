...
contract NFT is ERC721Enumerable, Ownable {
    ...
    uint256 maxSupply = 6;
    uint256 cost = 0.00001 ether; //0.0001 BNB
    string baseURI = "ipfs://QmbDzzCKR3Zu5YBNVZYVTFfSMQtrFTWVV6B6mgWhXLwuVU/"; //"https://raw.githubusercontent.com/durdomtut0/airdropStarter/main/NFT-data/metadata/";//"https://raw.githubusercontent.com/durdomtut0/NFT-metadata/main/metadata/";
    ...
    constructor() ERC721("AssignmentNFT", "NFT") {}
    ...
    function safeMint(address _to) public payable {
        ...
        _safeMint(_to, _currentSupply + 2);
        _safeMint(_to, _currentSupply + 3);
        _safeMint(_to, _currentSupply + 4);
        _safeMint(_to, _currentSupply + 5);
    }
